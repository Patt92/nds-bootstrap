...
int runNds(u32 cluster, u32 saveCluster, u32 donorTwlCluster, /* u32 gbaCluster, u32 gbaSavCluster, */ u32 quitCluster, u32 wideCheatCluster, u32 apPatchCluster, u32 apPatchPostCardReadCluster, u32 dsi2dsSavePatchCluster, u32 cheatCluster, u32 patchOffsetCacheCluster, u32 ramDumpCluster, u32 srParamsCluster, u32 screenshotCluster, u32 apFixOverlaysCluster, u32 musicCluster, u32 pageFileCluster, u32 manualCluster, u32 rtsFileCluster, u32 sharedFontCluster, configuration* conf) {
	...
	loader->quitFileCluster             = quitCluster;
	for (int i = 0; i < 4; i++) {
	...
	loader->rtsFileCluster              = rtsFileCluster;
